    ...
    constructor(packet) {
        ...
        switch(entityTypeId) {
            case HEntityType.HABBO:
                ...
                this.#stuff.push(packet.readInteger());
                this.#favoriteGroup = packet.readInteger();
...
class HEntityUpdate {
    ...
    constructor(packet) {
        ...
        this.#index = packet.readInteger();
        this.#tile = new HPoint(packet.readInteger(), packet.readInteger(), parseFloat());
        ...
        for(let actionInfo of actionData) {
            ...
            switch(actionValues[0]) {
                ...
                case "mv":
                    ...
                    if(values.length >= 3)
                        this.#movingTo = new HPoint(parseInt(values[0]), parseInt(values[1]), parseFloat(values[2]));
                ...
                case "sit":
                    ...
                    break;
                case "sign":
                    this.#sign = parseInt(actionValues[1]);
...
exports = { HEntity, HEntityUpdate, HEntityType, HGender, HSign, HStance, HAction };

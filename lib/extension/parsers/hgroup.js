...
exports.HGroup = class HGroup {
    ...
    appendToPacket(packet) {
        ...
        packet.appendString(this.#badgeCode);
        packet.appendString(this.#primaryColor);
        packet.appendString(this.#secondaryColor);

        packet.appendBoolean(this.#isFavorite);
        packet.appendInt(this.#ownerId);
        packet.appendBoolean(this.#hasForum);
    }
